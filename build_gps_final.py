    ...
    with ThreadPoolExecutor(max_workers=workers) as pool:
        ...
        for fut in as_completed(futures):
            ...
            if not name_raw:
                ...
                # live site.
                continue
            # Skip individual practitioner entries (e.g. "Dr Mojgan
            # Fitzmaurice") that aren't real GP practices.
            if re.match(r"^(?:dr|mr|mrs|ms|miss|prof)\.?\s", name_raw, re.IGNORECASE) \
               and not re.search(r"\b(?:surgery|practice|centre|center|clinic|"
                                 r"medical|health|partnership|group)s?\b",
